...
<meta name="theme-color" content="#563d7c">
  ...
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">STR | MOF LAOS</a>
  <input class="form-control form-control-dark w-100" type="text" placeholder="Search" aria-label="Search" autofocus>
